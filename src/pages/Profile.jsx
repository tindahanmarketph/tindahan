...
function MobileProfileMenuItem({
  ...
  const content = (
    <>
      <span className="mobile-profile-menu-icon">
        {icon}
      </span>
      ...
      {value && (
        <span className="mobile-profile-menu-value">
          {value}
        </span>
      )}
      ...
      {!onClick && (
        <ChevronRight
          size={22}
          className="mobile-profile-menu-chevron"
        />
      )}
    </>
  );
  ...
  return (
    <section className="mobile-profile-dashboard">
      ...
      <div className="mobile-profile-content">
        ...
        <Link
          to="/badges"
          className="mobile-profile-badges-card"
        >
...
function ReviewStars({ rating }) {
  ...
  return (
    <div
      ...
      aria-label={`${cleanRating} out of 5`}
    >
      {[1, 2, 3, 4, 5].map((star) => (
        <span
          key={star}
    ...
    >
      <header className="profile-reviews-header">
        <div>
          ...
          <p>
            Reviews left by buyers and sellers after
            completed TindaHan orders.
          </p>
        </div>
      ...
      {hasReviews ? (
        ...
        <div className="profile-reviews-empty">
          ...
          <p>
            Reviews will appear here after completed
            orders with other TindaHan members.
          </p>
        </div>
      )}
    </section>
...
export default function Profile() {
    ...
    async function loadProfile() {
      ...
      const [
        ...
        getReviewsForUser(
          ...
          console.warn(
            "Profile reviews loading skipped:",
            error.message
          );
  ...
  async function handleLogout() {
    const confirmed =
      window.confirm(
        "Do you want to log out from TindaHan?"
      );
      ...
      <main className="profile-page page">
        <div className="container">
          <div className="empty-state">
            ...
            <p>
              This user does not exist or is no longer
              available.
            </p>
          </div>
        </div>
  ...
  const holidayModeEnabled =
    Boolean(profile?.holiday_mode);
      ...
      <div className="container profile-container">
                ...
                {holidayModeEnabled &&
                  isOwnProfile && (
                    <p className="profile-holiday-status">
                      Holiday mode is active. Your
                      listings are hidden from buyers.
                    </p>
                  )}
            ...
            <div className="profile-info-grid">
              <div className="profile-info-block">
                ...
                <div className="profile-meta-line">
                  ...
                  <Link
                    to={`/profile/${displayedUsername}/followers`}
                  >
                    0 followers
                  </Link>
                  ...
                  <Link
                    to={`/profile/${displayedUsername}/following`}
                  >
                    0 following
                  </Link>
                </div>
        ...
        <section className="profile-tabs">
          <a
            ...
            className="profile-tab profile-tab-link active"
          >
            Listings
          </a>
          ...
          <a
            ...
            className="profile-tab profile-tab-link"
          >
            Reviews
          </a>
        </section>
        ...
        <section className="profile-badges">
          <article className="profile-badge-card">
            ...
            <div>
              ...
              <p>
                Upload 5 items within 30 days to earn
                the Active Publisher badge.
              </p>
            </div>

            <Info
              className="profile-badge-info"
              size={21}
            />
          </article>
          ...
          <article className="profile-badge-card">
            ...
            <div>
              <h3>
                Ready for the Fast Shipping badge?
              </h3>

              <p>
                Ship the items you sell within the
                next 24 hours so this badge can be
                visible to buyers.
              </p>
            </div>
        ...
        {listings.length > 0 ? (
          ...
          <section
            className="profile-empty-listings"
            id="profile-listings"
          >
